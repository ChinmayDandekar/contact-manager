...
export const searchByPhone = async (req, res, next) => {
    ...
    if (typeof phone !== "string")
        throw new BadRequestsException("Invalid Query", ErrorCode.INCORRECT_QUERY);
    ...
    if (searchResults.length == 0)
        throw new NotFoundException("Contacts not found", ErrorCode.CONTACT_NOT_FOUND);
    return res.json(searchResults);
};
export const getDetailsByPhone = async (req, res, next) => {
